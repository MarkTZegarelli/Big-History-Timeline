...
export const CATEGORY_SPAN_YEARS = {
  ...
  [CATEGORIES.BIOLOGICAL]:  3_800_000_000,
...
export const PREDEFINED_EVENTS = [
  ...
  },
  {
    ...
    description: `The oldest evidence of life is not a fossil but a chemical signal: carbon isotope ratios (δ¹³C) in ~3.7–3.8-billion-year-old rocks from Isua, Greenland show the preferential uptake of lighter carbon that living organisms perform. These geochemical biosignatures are debated but represent the current earliest frontier of evidence for life. The organisms responsible were almost certainly prokaryotes — though body fossils confirming this do not appear until roughly 300 million years later (see: First Prokaryotes).`,
  ...
  },
  {
    ...
    description: `Cyanobacteria evolved oxygenic photosynthesis — the ability to split water molecules using sunlight and release oxygen as a by-product. This was one of the most consequential biological innovations in Earth's history: it transformed the atmosphere, poisoned most anaerobic life, and ultimately made aerobic respiration (and complex animals) possible. The geological record of this event is the Great Oxidation Event ~2.4 billion years ago.`,
...

  {
    ...
    description: `While geochemical biosignatures hint at life as early as 3.8 billion years ago (see: First Life on Earth), the ~3.5-billion-year-old Apex Chert of Western Australia preserves the oldest widely accepted body fossils: microscopic filaments and rods identified as prokaryotes — single-celled organisms (bacteria and archaea) lacking a membrane-bound nucleus. This is the transition from chemical inference to physical evidence. Prokaryotes dominated life for over a billion years, colonising every available niche and driving the chemistry of Earth's oceans and atmosphere before eukaryotes appeared through endosymbiosis roughly 1.4 billion years later.`,
